...
import { League } from '@/components/providers/team-provider';
...
export default function PublicLeagueScorekeeperHub() {
  ...
  if (!league) return <div className="min-h-screen flex items-center justify-center p-6"><Card className="max-w-md text-center p-10"><AlertCircle className="h-12 w-12 mx-auto mb-4 text-destructive" /><h2 className="text-xl font-bold">League Not Found</h2></Card></div>;
    ...
    <div className="min-h-screen bg-muted/10 flex flex-col items-center py-12 px-6">
      ...
      <div className="max-w-3xl w-full space-y-8">
        <header className="bg-black text-white p-10 rounded-[3rem] shadow-2xl space-y-4">
          ...
          <p className="text-white/60 font-bold uppercase tracking-widest text-xs">Official Result Entry Hub</p>
        </header>

        <div className="grid grid-cols-1 gap-4">
          <h2 className="text-xs font-black uppercase tracking-[0.3em] text-muted-foreground ml-4">Season Match Ledger</h2>
                ...
                <div className="flex items-center gap-6 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] font-bold text-muted-foreground uppercase flex items-center gap-1">
                      <MapPin className="h-3 w-3" /> {game.location || 'League Venue'}
                    </p>
                  </div>
                </div>
