      ...
      <header className="sticky top-0 z-40 bg-background/95 backdrop-blur-md border-b">
        <div className="max-w-7xl mx-auto px-4 md:px-8 h-16 md:h-20 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 shrink-0">
            <Link href="/" aria-label="Home" className="hidden md:block"><BrandLogo variant="light-background" className="h-8 w-36" /></Link>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/sports-hub/search" className="lg:hidden"><Button aria-label="Search Sports Hub" variant="ghost" size="icon" className="h-10 w-10 rounded-xl"><Search className="h-4 w-4" /></Button></Link>
            <Link href="/login" className="hidden md:block"><Button size="sm" className="font-black text-xs uppercase tracking-widest">Get Started</Button></Link>
          </div>
        </div>
        <nav aria-label="The Squad" className="h-12 px-4 flex items-center justify-between gap-2 border-t md:hidden">
          <Link href="/" className="inline-flex h-10 items-center px-2 text-[10px] font-black uppercase tracking-wider">Home</Link>
          <Link href="/dashboard" className="inline-flex h-10 items-center gap-1 px-2 text-[10px] font-black uppercase tracking-wider"><ChevronLeft className="h-3.5 w-3.5" />Back to App</Link>
          <Button asChild size="sm" className="text-[10px] font-black uppercase tracking-wider"><Link href="/login">Get Started</Link></Button>
        </nav>
      </header>
      <SectionNav />
