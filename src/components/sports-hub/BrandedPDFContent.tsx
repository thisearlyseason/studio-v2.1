    ...
    >
      ...
      <div style={{ backgroundColor: BRAND_RED, padding: '20px 32px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div style={{ textAlign: 'right' }}>
          ...
          <div style={{ fontSize: '9px', color: 'rgba(255,255,255,0.6)', letterSpacing: '0.05em' }}>www.thesquad.pro/sports-hub</div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <span style={{ fontSize: '9px', color: BRAND_GRAY }}>Sports Hub · www.thesquad.pro</span>
      </div>
    </div>
  );
}
